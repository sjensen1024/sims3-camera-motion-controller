...
class TestMotionControlSequence(unittest.TestCase):
    ...
    def test_when_run_given_various_actions_then_should_run_actions_within_duration_even_if_they_happen_at_the_same_time(self):
        ...
        in_bounds_action_3 = Action(0.5, camera_operator.movement_tracker, "start_raising")
        in_bounds_action_4 = Action(2, camera_operator.movement_tracker, "stop_moving_forward")
        in_bounds_action_5 = Action(2, camera_operator.movement_tracker, "stop_raising")
        in_bounds_action_6 = Action(2.5, camera_operator, "stop_recording")
        ...
        sequence.add_action(in_bounds_action_5)
        sequence.add_action(in_bounds_action_6)
