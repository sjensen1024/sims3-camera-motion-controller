...
class TestMovementTracker(unittest.TestCase):
    ...
    def test_suite_for_init(self):
        ...
        self._test_that_all_movement_tracking_boolean_attributes_are_false()
    ...
    def test_suite_for_moving_forward(self):
        ...
        self._test_start_and_stop_method_scenarios_for_standard_movement(*test_args)
    ...
    def test_when_stop_all_tracked_movements_given_flags_were_set_to_true_then_now_they_should_all_be_false(self):
        ...
        self._test_that_all_movement_tracking_boolean_attributes_are_false()
        self._teardown_release_keys_mock()

    def test_when_level_out_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('level_out', KeySet.LEVEL_OUT.value)

    def test_when_move_to_position_5_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('move_to_position_5', KeySet.MOVE_TO_POSITION_5.value)

    def test_when_move_to_position_6_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('move_to_position_6', KeySet.MOVE_TO_POSITION_6.value)

    def test_when_move_to_position_7_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('move_to_position_7', KeySet.MOVE_TO_POSITION_7.value)

    def test_when_move_to_position_8_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('move_to_position_8', KeySet.MOVE_TO_POSITION_8.value)

    def test_when_move_to_position_9_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('move_to_position_9', KeySet.MOVE_TO_POSITION_9.value)

    def test_when_snap_to_position_5_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('snap_to_position_5', KeySet.SNAP_TO_POSITION_5.value)

    def test_when_snap_to_position_6_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('snap_to_position_6', KeySet.SNAP_TO_POSITION_6.value)

    def test_when_snap_to_position_7_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('snap_to_position_7', KeySet.SNAP_TO_POSITION_7.value)

    def test_when_snap_to_position_8_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('snap_to_position_8', KeySet.SNAP_TO_POSITION_8.value)

    def test_when_snap_to_position_9_then_should_hit_correct_key_and_stop_all_tracked_movements(self):
         self._test_method_that_hits_keys_and_stops_all_other_movements('snap_to_position_9', KeySet.SNAP_TO_POSITION_9.value)

    def _test_start_and_stop_method_scenarios_for_standard_movement(self, 
                                                                     start_movement_method_name, 
                                                                     stop_movement_method_name, 
                                                                     movement_attribute_name,
                                                                     movement_key_set, 
                                                                     stop_countermovement_method_name):
        self._test_start_movement_when_not_started_yet(start_movement_method_name, movement_attribute_name, movement_key_set, stop_countermovement_method_name)
        self._test_start_movement_when_already_started(start_movement_method_name, movement_attribute_name, stop_countermovement_method_name)
        self._test_stop_movement_when_started(stop_movement_method_name, movement_attribute_name, movement_key_set)
        self._test_stop_movement_when_not_started_yet(stop_movement_method_name, movement_attribute_name)
        

    def _test_start_movement_when_not_started_yet(self, 
                                                   start_movement_method_name, 
                                                   movement_attribute_name, 
                                                   expected_key_set, 
                                                   countermovement_method_name):
        self._setup_press_keys_mock()
        ...
        self._teardown_press_keys_mock()

    def _test_start_movement_when_already_started(self, 
                                                   start_movement_method_name, 
                                                   movement_attribute_name, 
                                                   countermovement_method_name):
        self._setup_press_keys_mock()
    ...
    def _test_stop_movement_when_started(self, stop_movement_method_name, movement_attribute_name, expected_key_set):
        self._setup_release_keys_mock()
        setattr(self.movement_tracker, movement_attribute_name, True)
    ...
    def _test_stop_movement_when_not_started_yet(self, stop_movement_method_name, movement_attribute_name):
        self._setup_release_keys_mock()
        stop_movement_method = getattr(self.movement_tracker, stop_movement_method_name)
        stop_movement_method()
    ...
    def _test_that_all_movement_tracking_boolean_attributes_are_false(self):
    ...
    def _test_method_that_hits_keys_and_stops_all_other_movements(self, method_name, keys):
    ...
    def _teardown_press_keys_mock(self):
        KeyOperator.press_keys = self.original_press_keys

    def _teardown_release_keys_mock(self):
